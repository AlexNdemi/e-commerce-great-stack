...
const OurPolicy:FC = () => {
  ...
  return (
    <div className={`flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base ${theme === "dark"?"text-textDark-900": "text-textLight-900"}`}>
      <div>
